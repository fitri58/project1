...
<body>
    <h1 class="h1 text-center">BANK SITI SA'ADA TULFITRI</h1>
<?php
class Account{
    public $nomor;
    protected $saldo;
...
class AccountBank extends Account{
    ...
    $pmlk1 = new AccountBank("C001", 6000000, "Puja");
    $pmlk2 = new AccountBank("C002", 5350000, "Fitri");
    $pmlk3 = new AccountBank("C003", 2500000, "Aprisa");
...
echo "<hr>puja nabung 1.000.000";
echo "<br>puja transfer 1.500.000 ke aprisa dan 500.000 ke fitri";
echo "<br>fitri tarik uang 2.500.000";
?>
<table class="table">
    <thead>
        <tr>
